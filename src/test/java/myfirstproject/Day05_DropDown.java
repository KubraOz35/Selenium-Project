...
// Print "Expected Is Not Equal Actual" if there are not 4 elements in the dropdown.
    ...
    public void selectByIndexTest() throws InterruptedException {
        ...
        //3-Select any option by using selectByIndex  -   Note that index start from 0
        Thread.sleep(3000);//not must,we added for seeing the steps
        select.selectByIndex(1);//option 1
        Thread.sleep(3000);//option 2
    ...
    public void selectByVisibleTextTest() throws InterruptedException {
        ...
        //2-Create a a select object
        Select select = new Select(dropDown);
        //3-Select any option by using selectByVisibleTextTest
        Thread.sleep(3000);
    ...
    public void sizeTest(){
        ...
        // Print "Expected Is Not Equal Actual" if there are not 4 elements in the dropdown.
        Assert.assertEquals("Expected Is Not Equal Actual",4,sizeOfDropDown);
    }
